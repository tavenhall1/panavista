...
`;const Qt={sunny:t=>R`
    ...
    `],t([vt({attribute:!1})],ne.prototype,"hass",void 0),t([gt()],ne.prototype,"_config",void 0),ne=t([dt("panavista-grid-card")],ne);let se=class extends lt{constructor(){super(...arguments),this._pv=new Et(this)}setConfig(t){this._config={entity:"sensor.panavista_config",max_events:10,days_ahead:7,show_calendar_name:!0,show_end_time:!1,...t}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=bt(this.hass,this._config?.entity);zt(this,Mt(this._config?.theme,t?.display?.theme))}}render(){if(!this._config||!this.hass)return W;const t=bt(this.hass,this._config.entity);if(!t)return R`<ha-card><div style="padding:1rem;text-align:center;color:var(--pv-text-muted)">No data</div></ha-card>`;const e=Wt(t.events||[],this._pv.state.hiddenCalendars),i=this._config.time_format||t.display?.time_format||"12h";return R`
      <ha-card>
    ...
    `],t([vt({attribute:!1})],se.prototype,"hass",void 0),t([gt()],se.prototype,"_config",void 0),se=t([dt("panavista-agenda-card")],se);let oe=class extends lt{constructor(){super(...arguments),this._time="",this._date=""}setConfig(t){this._config={entity:"sensor.panavista_config",size:"large",show_date:!0,show_seconds:!1,time_format:void 0,align:"center",...t}}connectedCallback(){super.connectedCallback(),this._updateTime(),this._timer=setInterval(()=>this._updateTime(),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&(clearInterval(this._timer),this._timer=void 0)}_updateTime(){const t=new Date,e=this._config?.time_format||this._getDisplayConfig()?.time_format||"12h",i=this._config?.show_seconds||!1;if("24h"===e){const e=String(t.getHours()).padStart(2,"0"),a=String(t.getMinutes()).padStart(2,"0"),r=String(t.getSeconds()).padStart(2,"0");this._time=i?`${e}:${a}:${r}`:`${e}:${a}`}else{let e=t.getHours();const a=e>=12?"PM":"AM";e=e%12||12;const r=String(t.getMinutes()).padStart(2,"0"),n=String(t.getSeconds()).padStart(2,"0"),s=i?`${e}:${r}:${n}`:`${e}:${r}`;this._time=`${s}|${a}`}!1!==this._config?.show_date&&(this._date=$t(t,"long"))}_getDisplayConfig(){if(!this.hass)return;const t=bt(this.hass,this._config?.entity);return t?.display}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=this._getDisplayConfig();zt(this,Mt(this._config?.theme,t?.theme))}}render(){if(!this._config)return W;const t=this._config.size||"large",e=this._config.align||"center",i=`${this._config.background?`background: ${this._config.background};`:""}${this._config.text_color?`color: ${this._config.text_color};`:""}`,a=this._time.split("|"),r=a[0],n=a[1]||"";return R`
      <ha-card style="${i}">
