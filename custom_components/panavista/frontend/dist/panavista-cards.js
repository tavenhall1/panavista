...
`;var ke;let Fe=ke=class extends oe{constructor(){super(...arguments),this.value="",this.valueLight="",this._isCustom=!1}updated(e){if(super.updated(e),e.has("value")&&this.value){const e=ke.PRESETS.some(e=>e.color.toLowerCase()===this.value.toLowerCase());this._isCustom=!e}}_selectPreset(e){this._isCustom=!1,this._emit(e.color,e.light)}_openCustomPicker(){this._colorInput?.click()}_onCustomColorChange(e){const t=e.target.value,i=function(e){let t=e.replace("#","");if(3===t.length&&(t=t.split("").map(e=>e+e).join("")),6!==t.length)return e;const i=parseInt(t.substring(0,2),16),r=parseInt(t.substring(2,4),16),a=parseInt(t.substring(4,6),16);if(isNaN(i)||isNaN(r)||isNaN(a))return e;const n=Math.round(i+.65*(255-i)),s=Math.round(r+.65*(255-r)),o=Math.round(a+.65*(255-a)),l=e=>e.toString(16).padStart(2,"0");return`#${l(n)}${l(s)}${l(o)}`}(t);this._isCustom=!0,this._emit(t,i)}_emit(e,t){this.value=e,this.valueLight=t,this.dispatchEvent(new CustomEvent("color-change",{detail:{color:e,colorLight:t},bubbles:!0,composed:!0}))}_isSelected(e){return this.value.toLowerCase()===e.toLowerCase()}render(){const e=ke.PRESETS,t=this._isCustom?this.value:"",i=this._isCustom&&!!this.value;return N`
    ...
    `}_onClick(){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:this.event},bubbles:!0,composed:!0}))}};it.styles=[ge,s`
      :host { display: block; }
  ...
  `,e([he({attribute:!1})],ot.prototype,"hass",void 0),ot=e([de("panavista-calendar-card-editor")],ot);let lt=class extends oe{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.timeFormat="12h",this.hideColumnHeaders=!1,this.avatarBorderMode="primary",this.sharedEventMap=new Map,this.tick=0}firstUpdated(){this._scrollToNow()}updated(e){super.updated(e),e.has("currentDate")&&this._scrollToNow()}_scrollToNow(){requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".time-grid-wrapper");if(!e)return;this._scrollContainer=e;const t=new Date,i=60*(t.getHours()-0)+t.getMinutes();if(i>0&&i<1440){const t=i/1440*e.scrollHeight-e.clientHeight/3;e.scrollTo({top:Math.max(0,t),behavior:"smooth"})}})}render(){const e=He(this.events,this.hiddenCalendars),t=new Date(this.currentDate);t.setHours(0,0,0,0);const i=new Date(this.currentDate);i.setHours(23,59,59,999);const r=Pe(e,t,i),a=r.filter(e=>Be(e)),n=r.filter(e=>!Be(e)),s=this.calendars.filter(e=>!1!==e.visible&&!this.hiddenCalendars.has(e.entity_id)),o=function(e,t){const i=new Map,r=new Map(t.map(e=>[e.entity_id,e]));for(const e of t)if(!1!==e.visible){const t=e.person_entity||e.entity_id;i.has(t)||i.set(t,[])}for(const t of e){const e=r.get(t.calendar_entity_id),a=e?.person_entity||t.calendar_entity_id;i.has(a)||i.set(a,[]),i.get(a).push(t)}return i}(n,s),l=Array.from(o.keys()),d=new Date,c=d.toDateString()===this.currentDate.toDateString(),p=60*(d.getHours()-0)+d.getMinutes(),h=c?p/1440*100:-1;return 0===s.length?N`
      ...
      <div class="day-container">
        ...
        ${this.hideColumnHeaders?W:N`
          <div class="column-headers">
            ...
            ${l.map(e=>{const t=s.find(t=>(t.person_entity||t.entity_id)===e),i=t?.person_entity?et(this.hass,t.person_entity):null,r=t?.person_entity?tt(this.hass,t.person_entity):t?.display_name||e,a=t?.color||"#6366F1",n=t?.color_light||a,o="light"===this.avatarBorderMode?n:"primary"===this.avatarBorderMode?a:this.avatarBorderMode;return N`
    ...
    `}_goToToday(){this.dispatchEvent(new CustomEvent("day-click",{detail:{date:new Date},bubbles:!0,composed:!0}))}_goToNextDay(){const e=new Date(this.currentDate);e.setDate(e.getDate()+1),this.dispatchEvent(new CustomEvent("day-click",{detail:{date:e},bubbles:!0,composed:!0}))}_renderColumn(e,t){const i=function(e){const t=e.filter(e=>!Be(e)).sort((e,t)=>new Date(e.start).getTime()-new Date(t.start).getTime());if(0===t.length)return[];const i=t.map(e=>({event:e,start:new Date(e.start).getTime(),end:new Date(e.end).getTime(),column:0,cluster:0}));let r=0,a=0;for(let e=0;e<i.length;e++){let t=!1;for(let r=a;r<e;r++)if(i[e].start<i[r].end){t=!0;break}if(!t&&e>a){const t=e;let n=0;for(let e=a;e<t;e++)n=Math.max(n,i[e].column+1);for(let e=a;e<t;e++)i[e].cluster=r;r++,a=e}const n=new Set;for(let t=a;t<e;t++)i[e].start<i[t].end&&n.add(i[t].column);let s=0;for(;n.has(s);)s++;i[e].column=s}i.forEach((e,t)=>{t>=a&&(e.cluster=r)});const n=new Map;for(const e of i){const t=n.get(e.cluster)||0;n.set(e.cluster,Math.max(t,e.column+1))}return i.map(e=>({...e.event,column:e.column,totalColumns:n.get(e.cluster)||1}))}(t);return N`
      <div class="person-column">
        ${i.map(e=>{const t=function(e,t=0,i=24){const r=new Date(e.start),a=new Date(e.end),n=60*(i-t);let s,o;return s=Math.max(0,60*(r.getHours()-t)+r.getMinutes()),o=Math.min(n,60*(a.getHours()-t)+a.getMinutes()),a.toDateString()!==r.toDateString()&&o<=0&&(o=n),s=Math.max(0,Math.min(s,n)),o=Math.max(0,Math.min(o,n)),{top:s/n*100,height:Math.max(o-s,15)/n*100}}(e,0,24),i=e.totalColumns>1?`calc(${100/e.totalColumns}% - 6px)`:"calc(100% - 6px)",r=e.totalColumns>1?`calc(${e.column/e.totalColumns*100}% + 3px)`:"3px",a=e.uid?this.sharedEventMap.get(e.uid):void 0,n=a&&a.length>1;return N`
            <div
              class="positioned-event${Te(e)?" past":""}"
              style="
                top: ${t.top}%;
                height: ${t.height}%;
                width: ${i};
    ...
    `}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};lt.styles=[ge,fe,_e,we,s`
    ...
    `}_renderDayCard(e,t,i){const r=De(e),a=Ae(e),n=new Date(e);n.setHours(0,0,0,0);const s=new Date(e);s.setHours(23,59,59,999);const o=t.filter(e=>{const t=new Date(e.start),i=new Date(e.end);return t<s&&i>n}).sort((e,t)=>{const i=Be(e),r=Be(t);return i&&!r?-1:!i&&r?1:new Date(e.start).getTime()-new Date(t.start).getTime()}),l=i.get(a),d=`${dt[e.getDay()]} ${e.getDate()}`,c=o.length;return N`
    ...
    `}_addEvent(e){this.dispatchEvent(new CustomEvent("create-event",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};ct.styles=[ge,we,s`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `}_renderDayCell(e,t,i){const r=Ae(e),a=i.get(r)||[],n=e.getMonth()!==t,s=De(e),o=a.slice(0,3),l=a.length-3;return N`
      <div
    ...
    `}_onDayClick(e){this.dispatchEvent(new CustomEvent("day-click",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};vt.styles=[ge,s`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `}updated(e){super.updated(e),(e.has("weatherEntity")||e.has("hass"))&&this._subscribeWeather()}disconnectedCallback(){super.disconnectedCallback(),this._unsubWeather()}_unsubWeather(){this._weatherUnsub&&(this._weatherUnsub(),this._weatherUnsub=void 0),this._subscribedEntity=""}async _subscribeWeather(){if(!this.weatherEntity||!this.hass?.connection)return this._unsubWeather(),void(this._forecast=[]);if(this._subscribedEntity!==this.weatherEntity||!this._weatherUnsub){this._unsubWeather(),this._subscribedEntity=this.weatherEntity;try{this._weatherUnsub=await this.hass.connection.subscribeMessage(e=>{this._forecast=e.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:this.weatherEntity})}catch{const e=this.hass.states[this.weatherEntity];e?.attributes?.forecast&&(this._forecast=e.attributes.forecast)}}}_getForecastMap(){const e=new Map;for(const t of this._forecast){if(!t.datetime)continue;const i=Ae(new Date(t.datetime));e.set(i,{condition:t.condition||"",tempHigh:t.temperature??0,tempLow:t.templow??t.temperature??0})}return e}_loadMore(){this._daysLoaded+=14}_addEvent(e){this.dispatchEvent(new CustomEvent("create-event",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};gt.styles=[ge,we,s`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],e([he({attribute:!1})],ft.prototype,"hass",void 0),e([he({type:Array})],ft.prototype,"calendars",void 0),e([he({type:Boolean})],ft.prototype,"open",void 0),e([he({type:String})],ft.prototype,"mode",void 0),e([he({type:Object})],ft.prototype,"prefill",void 0),e([he({attribute:!1})],ft.prototype,"timeFormat",void 0),e([ve()],ft.prototype,"_title",void 0),e([ve()],ft.prototype,"_selectedCalendars",void 0),e([ve()],ft.prototype,"_originalCalendars",void 0),e([ve()],ft.prototype,"_organizerEntityId",void 0),e([ve()],ft.prototype,"_date",void 0),e([ve()],ft.prototype,"_startTime",void 0),e([ve()],ft.prototype,"_endTime",void 0),e([ve()],ft.prototype,"_allDay",void 0),e([ve()],ft.prototype,"_description",void 0),e([ve()],ft.prototype,"_location",void 0),e([ve()],ft.prototype,"_showMore",void 0),e([ve()],ft.prototype,"_saving",void 0),e([ve()],ft.prototype,"_error",void 0),e([ve()],ft.prototype,"_removeGuestsHint",void 0),e([ve()],ft.prototype,"_datePickerOpen",void 0),e([ve()],ft.prototype,"_pickerMonth",void 0),e([ve()],ft.prototype,"_pickerYear",void 0),e([ve()],ft.prototype,"_activeTimePicker",void 0),e([ve()],ft.prototype,"_locationSuggestions",void 0),e([ve()],ft.prototype,"_locationLoading",void 0),e([ve()],ft.prototype,"_locationFocused",void 0),e([me("#title-input")],ft.prototype,"_titleInput",void 0),e([me(".location-input")],ft.prototype,"_locationInput",void 0),e([me(".date-display")],ft.prototype,"_dateDisplay",void 0),e([me(".start-time-display")],ft.prototype,"_startTimeEl",void 0),e([me(".end-time-display")],ft.prototype,"_endTimeEl",void 0),ft=e([de("pv-event-create-dialog")],ft);let bt=class extends oe{constructor(){super(...arguments),this._currentTime=new Date,this._filterOpen=!1,this._wizardOpen=!1,this._onboardingDone=!1,this._settingsOpen=!1,this._refreshing=!1,this._previewOverrides=null,this._pv=new at(this),this._clockTimer=null,this._touchStartX=0,this._filterCloseHandler=e=>this._onFilterClickOutside(e)}connectedCallback(){super.connectedCallback(),this._clockTimer=setInterval(()=>{this._currentTime=new Date},1e3)}disconnectedCallback(){super.disconnectedCallback(),this._clockTimer&&(clearInterval(this._clockTimer),this._clockTimer=null),document.removeEventListener("click",this._filterCloseHandler)}setConfig(e){this._config={entity:"sensor.panavista_config",...e};const t=e?.view||e?.default_view;t&&this._pv.state.setView(t)}firstUpdated(){if(!this._config?.view&&!this._config?.default_view){const e=this.hass?Ke(this.hass,this._config?.entity):null;e?.display?.default_view&&this._pv.state.setView(e.display.default_view)}}updated(e){if(super.updated(e),!this._settingsOpen&&(e.has("hass")||e.has("_config")||e.has("_settingsOpen"))){const e=Ke(this.hass,this._config?.entity);We(this,qe(this._config?.theme,e?.display?.theme),e?.display?.theme_overrides||null)}}_getData(){return Ke(this.hass,this._config?.entity)}_getWeatherEntity(){const e=this._getData(),t=this._config?.weather_entity||e?.display?.weather_entity;return t?this.hass?.states?.[t]:null}_getWeatherEntityId(){const e=this._getData();return this._config?.weather_entity||e?.display?.weather_entity||null}_resolveDisplay(){const e=this._getData(),t=e?.display,i=this._config;return{time_format:i?.time_format||t?.time_format||"12h",weather_entity:i?.weather_entity||t?.weather_entity||"",first_day:i?.first_day||t?.first_day||"sunday",default_view:i?.default_view||i?.view||t?.default_view||"week",theme:i?.theme||t?.theme||"light",theme_overrides:t?.theme_overrides}}_getVisibleCalendars(){const e=this._getData(),t=(e?.calendars||[]).filter(e=>!1!==e.visible),i=this._config?.calendars;return i&&Array.isArray(i)&&i.length>0?t.filter(e=>i.includes(e.entity_id)):t}_onOnboardingComplete(){this._wizardOpen=!1,this._onboardingDone=!0,Ye(this)}async _refreshCalendars(){if(!this._refreshing){this._refreshing=!0;try{const e=Ke(this.hass);if(e?.calendars)for(const t of e.calendars)t.entity_id&&await this.hass.callService("homeassistant","update_entity",{entity_id:t.entity_id});await this.hass.callService("homeassistant","update_entity",{entity_id:"sensor.panavista_config"})}catch{}setTimeout(()=>{this._refreshing=!1},800)}}_openSettings(){this._settingsOpen=!0}_onSettingsSave(){this._settingsOpen=!1,this._previewOverrides=null,Ye(this)}_onSettingsClose(){this._settingsOpen=!1,this._previewOverrides=null,Ye(this);const e=Ke(this.hass,this._config?.entity);We(this,qe(this._config?.theme,e?.display?.theme),e?.display?.theme_overrides||null)}_onThemePreview(e){const{theme:t,overrides:i}=e.detail,r=qe(t);Ye(this),We(this,r,i),this._previewOverrides=i}_showWeatherDetails(){const e=this._getWeatherEntityId();if(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}}render(){if(!this._config||!this.hass)return W;const e=this._getData();if(!e)return N`
      ...
      `;const t=this._pv.state,i=t.currentView;t.currentDate;const r=this._getVisibleCalendars(),a=e.events||[],n=this._resolveDisplay(),s=!!this._config?.hide_header,o=He(a,t.hiddenCalendars);return N`
      <ha-card>
