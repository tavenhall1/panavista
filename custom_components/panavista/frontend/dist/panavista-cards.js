...
`;var Ce;let Fe=Ce=class extends le{constructor(){super(...arguments),this.value="",this.valueLight="",this._isCustom=!1}updated(e){if(super.updated(e),e.has("value")&&this.value){const e=Ce.PRESETS.some(e=>e.color.toLowerCase()===this.value.toLowerCase());this._isCustom=!e}}_selectPreset(e){this._isCustom=!1,this._emit(e.color,e.light)}_openCustomPicker(){this._colorInput?.click()}_onCustomColorChange(e){const t=e.target.value,i=function(e){let t=e.replace("#","");if(3===t.length&&(t=t.split("").map(e=>e+e).join("")),6!==t.length)return e;const i=parseInt(t.substring(0,2),16),a=parseInt(t.substring(2,4),16),r=parseInt(t.substring(4,6),16);if(isNaN(i)||isNaN(a)||isNaN(r))return e;const n=Math.round(i+.88*(255-i)),s=Math.round(a+.88*(255-a)),o=Math.round(r+.88*(255-r)),l=e=>e.toString(16).padStart(2,"0");return`#${l(n)}${l(s)}${l(o)}`}(t);this._isCustom=!0,this._emit(t,i)}_emit(e,t){this.value=e,this.valueLight=t,this.dispatchEvent(new CustomEvent("color-change",{detail:{color:e,colorLight:t},bubbles:!0,composed:!0}))}_isSelected(e){return this.value.toLowerCase()===e.toLowerCase()}render(){const e=Ce.PRESETS,t=this._isCustom?this.value:"",i=this._isCustom&&!!this.value;return R`
    ...
    `],e([ve({type:String})],Fe.prototype,"value",void 0),e([ve({type:String})],Fe.prototype,"valueLight",void 0),e([ge()],Fe.prototype,"_isCustom",void 0),e([ue("#custom-color-input")],Fe.prototype,"_colorInput",void 0),Fe=Ce=e([de("pv-color-swatch-picker")],Fe);let De=class extends le{constructor(){super(...arguments),this._page=0,this._timeFormat="12h",this._firstDay="sunday",this._weatherEntity="",this._defaultView="week",this._calendarConfigs=[],this._calendarsInitialized=!1,this._theme="light",this._saving=!1}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._calendarsInitialized&&this._initCalendars()}_initCalendars(){const e=Fe.PRESETS,t=Object.keys(this.hass.states).filter(e=>e.startsWith("calendar.")).sort();this._calendarConfigs=t.map((t,i)=>{const a=e[i%e.length],r=this.hass.states[t]?.attributes?.friendly_name;return{entity_id:t,display_name:r||t,color:a.color,color_light:a.light,person_entity:"",include:!0}}),this._calendarsInitialized=!0}get _weatherEntities(){return this.hass?Object.keys(this.hass.states).filter(e=>e.startsWith("weather.")).sort():[]}get _personEntities(){return this.hass?Object.keys(this.hass.states).filter(e=>e.startsWith("person.")).sort():[]}_goBack(){this._page>0&&(this._page-=1)}async _goNext(){this._page<2?this._page+=1:await this._finish()}async _finish(){this._saving=!0;try{await this.hass.callService("panavista","save_config",{calendars:this._calendarConfigs.filter(e=>e.include).map(e=>({entity_id:e.entity_id,display_name:e.display_name,color:e.color,color_light:e.color_light,icon:"mdi:calendar",person_entity:e.person_entity,visible:!0})),display:{time_format:this._timeFormat,weather_entity:this._weatherEntity,first_day:this._firstDay,default_view:this._defaultView,theme:this._theme},onboarding_complete:!0}),this.dispatchEvent(new CustomEvent("onboarding-complete",{bubbles:!0,composed:!0}))}finally{this._saving=!1}}_updateCalendar(e,t){const i=[...this._calendarConfigs];i[e]={...i[e],...t},this._calendarConfigs=i}_onCalendarColorChange(e,t){t.stopPropagation(),this._updateCalendar(e,{color:t.detail.color,color_light:t.detail.colorLight})}_renderProgressDots(){return R`
          ...
          <div class="cal-field">
            ...
            >
              ...
              ${this._personEntities.map(t=>R`
                <option value="${t}" ?selected=${e.person_entity===t}>${t}</option>
              `)}
            </select>
          </div>
        </div>
    ...
    `}_renderFooter(){const e=2===this._page,t=e?this._saving?"Saving…":"Finish":"Next";return R`
    ...
    `}render(){return R`
      <div class="wizard-container" role="dialog" aria-modal="true" aria-label="PanaVista Setup — ${["Preferences","Calendars","Theme"][this._page]}">
    ...
    `}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};Je.styles=[me,be,_e,$e,o`
    ...
    `}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};et.styles=[me,be,_e,o`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],e([ve({attribute:!1})],et.prototype,"hass",void 0),e([ve({type:Array})],et.prototype,"events",void 0),e([ve({type:Array})],et.prototype,"calendars",void 0),e([ve({type:Object})],et.prototype,"currentDate",void 0),e([ve({type:Object})],et.prototype,"hiddenCalendars",void 0),e([ve({attribute:!1})],et.prototype,"timeFormat",void 0),e([ve({attribute:!1})],et.prototype,"firstDay",void 0),et=e([de("pv-view-week")],et);const tt=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],it=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let at=class extends le{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.firstDay="sunday"}render(){const e=Ze(this.events,this.hiddenCalendars),t=function(e,t="sunday"){const i=Le(new Date(e.getFullYear(),e.getMonth(),1),t),a=[];for(let e=0;e<42;e++){const t=new Date(i);t.setDate(i.getDate()+e),a.push(t)}return a}(this.currentDate,this.firstDay),i=We(e),a=this.currentDate.getMonth(),r="monday"===this.firstDay?it:tt;return R`
    ...
    `}_renderDayCell(e,t,i){const a=Oe(e),r=i.get(a)||[],n=e.getMonth()!==t,s=He(e),o=r.slice(0,3),l=r.length-3;return R`
      <div
    ...
    `}_onDayClick(e){this.dispatchEvent(new CustomEvent("day-click",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};at.styles=[me,be,o`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],e([ve({attribute:!1})],at.prototype,"hass",void 0),e([ve({type:Array})],at.prototype,"events",void 0),e([ve({type:Array})],at.prototype,"calendars",void 0),e([ve({type:Object})],at.prototype,"currentDate",void 0),e([ve({type:Object})],at.prototype,"hiddenCalendars",void 0),e([ve({attribute:!1})],at.prototype,"firstDay",void 0),at=e([de("pv-view-month")],at);let rt=class extends le{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.timeFormat="12h",this.maxEvents=20,this.daysAhead=14,this.showCalendarName=!0,this.showEndTime=!1}render(){const e=Ze(this.events,this.hiddenCalendars),t=new Date(this.currentDate);t.setHours(0,0,0,0);const i=new Date(this.currentDate);i.setDate(i.getDate()+this.daysAhead),i.setHours(23,59,59,999);const a=qe(e,t,i),r=We(a),n=Array.from(r.keys()).sort();let s=0;const o=this.maxHeight?`max-height: ${this.maxHeight}`:"";return 0===a.length?R`
      ...
      <div class="agenda-container" style="${o}">
        ${n.map(e=>{if(s>=this.maxEvents)return W;const t=r.get(e)||[],i=new Date(e+"T00:00:00"),a=function(e){if(He(e))return"Today";if(function(e){const t=new Date;return t.setDate(t.getDate()+1),e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}(e))return"Tomorrow";const t=new Date,i=Math.floor((e.getTime()-t.getTime())/864e5);return i<7&&i>=0?e.toLocaleDateString("en-US",{weekday:"long"}):Pe(e,"medium")}(i),n=Pe(i,"medium"),o=He(i),l=function(e){const t=new Date;t.setHours(0,0,0,0);const i=new Date(e);return i.setHours(0,0,0,0),i<t}(i)&&!o;return R`
    ...
    `}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};rt.styles=[me,be,$e,o`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],e([ve({attribute:!1})],rt.prototype,"hass",void 0),e([ve({type:Array})],rt.prototype,"events",void 0),e([ve({type:Array})],rt.prototype,"calendars",void 0),e([ve({type:Object})],rt.prototype,"currentDate",void 0),e([ve({type:Object})],rt.prototype,"hiddenCalendars",void 0),e([ve({attribute:!1})],rt.prototype,"timeFormat",void 0),e([ve({type:Number})],rt.prototype,"maxEvents",void 0),e([ve({type:Number})],rt.prototype,"daysAhead",void 0),e([ve({type:Boolean})],rt.prototype,"showCalendarName",void 0),e([ve({type:Boolean})],rt.prototype,"showEndTime",void 0),e([ve({attribute:!1})],rt.prototype,"maxHeight",void 0),rt=e([de("pv-view-agenda")],rt);let nt=class extends le{constructor(){super(...arguments),this.event=null,this.timeFormat="12h",this._confirmDelete=!1,this._deleting=!1,this._pv=new Ve(this)}render(){if(!this.event)return W;const e=this.event,t=Ye(e),i=new Date(e.start);return R`
    ...
    `}_renderDatePickerDropdown(){if(!this._datePickerOpen)return W;const e=this._dateDisplay;if(!e)return W;const t=e.getBoundingClientRect(),i=window.innerHeight-t.bottom-8<330&&t.top>330?t.top-330-4:t.bottom+4;return R`
      ...
      >
        ...
        <div class="picker-weekdays">
          ${st.map(e=>R`<span class="picker-weekday">${e}</span>`)}
        </div>
    ...
    `],e([ve({attribute:!1})],ot.prototype,"hass",void 0),e([ve({type:Array})],ot.prototype,"calendars",void 0),e([ve({type:Boolean})],ot.prototype,"open",void 0),e([ve({type:String})],ot.prototype,"mode",void 0),e([ve({type:Object})],ot.prototype,"prefill",void 0),e([ge()],ot.prototype,"_title",void 0),e([ge()],ot.prototype,"_calendarEntityId",void 0),e([ge()],ot.prototype,"_date",void 0),e([ge()],ot.prototype,"_startTime",void 0),e([ge()],ot.prototype,"_endTime",void 0),e([ge()],ot.prototype,"_allDay",void 0),e([ge()],ot.prototype,"_description",void 0),e([ge()],ot.prototype,"_location",void 0),e([ge()],ot.prototype,"_showMore",void 0),e([ge()],ot.prototype,"_saving",void 0),e([ge()],ot.prototype,"_error",void 0),e([ge()],ot.prototype,"_datePickerOpen",void 0),e([ge()],ot.prototype,"_pickerMonth",void 0),e([ge()],ot.prototype,"_pickerYear",void 0),e([ge()],ot.prototype,"_locationSuggestions",void 0),e([ge()],ot.prototype,"_locationLoading",void 0),e([ge()],ot.prototype,"_locationFocused",void 0),e([ue("#title-input")],ot.prototype,"_titleInput",void 0),e([ue(".location-input")],ot.prototype,"_locationInput",void 0),e([ue(".date-display")],ot.prototype,"_dateDisplay",void 0),ot=e([de("pv-event-create-dialog")],ot);let lt=class extends le{constructor(){super(...arguments),this._currentTime=new Date,this._filterOpen=!1,this._pv=new Ve(this),this._clockTimer=null,this._touchStartX=0,this._filterCloseHandler=e=>this._onFilterClickOutside(e)}connectedCallback(){super.connectedCallback(),this._clockTimer=setInterval(()=>{this._currentTime=new Date},1e3)}disconnectedCallback(){super.disconnectedCallback(),this._clockTimer&&(clearInterval(this._clockTimer),this._clockTimer=null),document.removeEventListener("click",this._filterCloseHandler)}setConfig(e){this._config={entity:"sensor.panavista_config",view:"day",...e},e?.view&&this._pv.state.setView(e.view)}firstUpdated(){if(!this._config?.view){const e=this.hass?ze(this.hass,this._config?.entity):null;e?.display?.default_view&&this._pv.state.setView(e.display.default_view)}}updated(e){if(super.updated(e),e.has("hass")||e.has("_config")){const e=ze(this.hass,this._config?.entity);Ne(this,Re(this._config?.theme,e?.display?.theme))}}_getData(){return ze(this.hass,this._config?.entity)}_getWeatherEntity(){const e=this._getData(),t=this._config?.weather_entity||e?.display?.weather_entity;return t?this.hass?.states?.[t]:null}_getWeatherEntityId(){const e=this._getData();return this._config?.weather_entity||e?.display?.weather_entity||null}_showWeatherDetails(){const e=this._getWeatherEntityId();if(e){const t=new CustomEvent("hass-more-info",{detail:{entityId:e},bubbles:!0,composed:!0});this.dispatchEvent(t)}}render(){if(!this._config||!this.hass)return W;const e=this._getData();if(!e)return R`
        <ha-card>
          <div class="pvc-empty">
    ...
    `}_onEventClick(e){this._pv.state.selectEvent(e.detail.event)}getCardSize(){return 4}static getStubConfig(){return{entity:"sensor.panavista_config",max_events:10,days_ahead:7}}};dt.styles=[me,o`
      :host { display: block; }
    ...
    `],e([ve({attribute:!1})],dt.prototype,"hass",void 0),e([ge()],dt.prototype,"_config",void 0),dt=e([de("panavista-agenda-card")],dt);let pt=class extends le{constructor(){super(...arguments),this._time="",this._date=""}setConfig(e){this._config={entity:"sensor.panavista_config",size:"large",show_date:!0,show_seconds:!1,time_format:void 0,align:"center",...e}}connectedCallback(){super.connectedCallback(),this._updateTime(),this._timer=setInterval(()=>this._updateTime(),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&(clearInterval(this._timer),this._timer=void 0)}_updateTime(){const e=new Date,t=this._config?.time_format||this._getDisplayConfig()?.time_format||"12h",i=this._config?.show_seconds||!1;if("24h"===t){const t=String(e.getHours()).padStart(2,"0"),a=String(e.getMinutes()).padStart(2,"0"),r=String(e.getSeconds()).padStart(2,"0");this._time=i?`${t}:${a}:${r}`:`${t}:${a}`}else{let t=e.getHours();const a=t>=12?"PM":"AM";t=t%12||12;const r=String(e.getMinutes()).padStart(2,"0"),n=String(e.getSeconds()).padStart(2,"0"),s=i?`${t}:${r}:${n}`:`${t}:${r}`;this._time=`${s}|${a}`}!1!==this._config?.show_date&&(this._date=Pe(e,"long"))}_getDisplayConfig(){if(!this.hass)return;const e=ze(this.hass,this._config?.entity);return e?.display}updated(e){if(super.updated(e),e.has("hass")||e.has("_config")){const e=this._getDisplayConfig();Ne(this,Re(this._config?.theme,e?.theme))}}render(){if(!this._config)return W;const e=this._config.size||"large",t=this._config.align||"center",i=`${this._config.background?`background: ${this._config.background};`:""}${this._config.text_color?`color: ${this._config.text_color};`:""}`,a=this._time.split("|"),r=a[0],n=a[1]||"";return R`
      <ha-card style="${i}">
    ...
    `}getCardSize(){const e=this._config?.size||"large";return"small"===e?2:"medium"===e?3:4}static getConfigElement(){return document.createElement("panavista-clock-card-editor")}static getStubConfig(){return{entity:"sensor.panavista_config",size:"large",show_date:!0}}};pt.styles=[me,o`
      :host {
        display: block;
      }
    ...
    `],e([ve({attribute:!1})],pt.prototype,"hass",void 0),e([ge()],pt.prototype,"_config",void 0),e([ge()],pt.prototype,"_time",void 0),e([ge()],pt.prototype,"_date",void 0),pt=e([de("panavista-clock-card")],pt);let ht=class extends le{setConfig(e){this._config=e}render(){return this._config?R`
      <div class="editor">
        <div class="row">
          <label>Size</label>
    ...
    `:W}_changed(e,t){const i={...this._config,[e]:t};""!==t&&void 0!==t||delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}};ht.styles=o`
    .editor {
      padding: 16px;
      display: flex;
      flex-direction: column;
  ...
  `,e([ve({attribute:!1})],ht.prototype,"hass",void 0),e([ge()],ht.prototype,"_config",void 0),ht=e([de("panavista-clock-card-editor")],ht);const vt={sunny:"linear-gradient(135deg, #FBBF24 0%, #F97316 100%)","clear-night":"linear-gradient(135deg, #1E3A5F 0%, #0F172A 100%)",cloudy:"linear-gradient(135deg, #94A3B8 0%, #64748B 100%)",partlycloudy:"linear-gradient(135deg, #60A5FA 0%, #818CF8 100%)",rainy:"linear-gradient(135deg, #475569 0%, #334155 100%)",pouring:"linear-gradient(135deg, #334155 0%, #1E293B 100%)",snowy:"linear-gradient(135deg, #CBD5E1 0%, #94A3B8 100%)",fog:"linear-gradient(135deg, #94A3B8 0%, #CBD5E1 100%)",lightning:"linear-gradient(135deg, #475569 0%, #1E293B 100%)",windy:"linear-gradient(135deg, #60A5FA 0%, #3B82F6 100%)",default:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"};let gt=class extends le{setConfig(e){this._config={entity:"sensor.panavista_config",show_details:!0,show_forecast:!1,layout:"horizontal",...e}}updated(e){if(super.updated(e),e.has("hass")||e.has("_config")){const e=this._getDisplayConfig();Ne(this,Re(this._config?.theme,e?.theme))}}_getDisplayConfig(){if(this.hass)return ze(this.hass,this._config?.entity)?.display}_getWeatherEntity(){const e=this._config?.weather_entity||this._getDisplayConfig()?.weather_entity;return e?this.hass?.states?.[e]:null}render(){if(!this._config||!this.hass)return W;const e=this._getWeatherEntity();if(!e)return R`
    ...
    `}getCardSize(){return this._config?.show_forecast?4:2}static getStubConfig(){return{entity:"sensor.panavista_config",show_details:!0,show_forecast:!1}}};gt.styles=[me,fe,o`
    ...
    `}getCardSize(){return 2}static getStubConfig(){return{entity:"sensor.panavista_config",show_names:!0,show_add_button:!0}}};ut.styles=[me,ye,o`
      :host { display: block; }
