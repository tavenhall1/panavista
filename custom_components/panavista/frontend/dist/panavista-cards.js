...
`;function It(t){const e=t.start,i=t.end;if(!e.includes("T")&&!i.includes("T"))return!0;const a=new Date(e),r=new Date(i);return 0===a.getHours()&&0===a.getMinutes()&&0===r.getHours()&&0===r.getMinutes()&&r.getTime()-a.getTime()>=864e5}function Nt(t){const e=new Map;for(const i of t){const t=new Date(i.start),a=new Date(i.end),r=new Date(t);r.setHours(0,0,0,0);const n=new Date(a);n.setHours(0,0,0,0);const s=It(i);for(;s?r<n:r<=n;){const t=Ct(r);e.has(t)||e.set(t,[]),e.get(t).push(i),r.setDate(r.getDate()+1)}}for(const[,t]of e)t.sort((t,e)=>{const i=It(t),a=It(e);return i&&!a?-1:!i&&a?1:new Date(t.start).getTime()-new Date(e.start).getTime()});return e}function Vt(t,e,i){return t.filter(t=>{const a=new Date(t.start),r=new Date(t.end);return a<i&&r>e})}function Rt(t,e=0,i=24,a){const r=new Date(t.start),n=new Date(t.end),s=60*(i-e);let o,l;return o=Math.max(0,60*(r.getHours()-e)+r.getMinutes()),l=Math.min(s,60*(n.getHours()-e)+n.getMinutes()),n.toDateString()!==r.toDateString()&&l<=0&&(l=s),o=Math.max(0,Math.min(o,s)),l=Math.max(0,Math.min(l,s)),{top:o/s*100,height:Math.max(l-o,15)/s*100}}function Yt(t){const e=t.filter(t=>!It(t)).sort((t,e)=>new Date(t.start).getTime()-new Date(e.start).getTime());if(0===e.length)return[];const i=e.map(t=>({event:t,start:new Date(t.start).getTime(),end:new Date(t.end).getTime(),column:0,cluster:0}));let a=0,r=0;for(let t=0;t<i.length;t++){let e=!1;for(let a=r;a<t;a++)if(i[t].start<i[a].end){e=!0;break}if(!e&&t>r){const e=t;let n=0;for(let t=r;t<e;t++)n=Math.max(n,i[t].column+1);for(let t=r;t<e;t++)i[t].cluster=a;a++,r=t}const n=new Set;for(let e=r;e<t;e++)i[t].start<i[e].end&&n.add(i[e].column);let s=0;for(;n.has(s);)s++;i[t].column=s}i.forEach((t,e)=>{e>=r&&(t.cluster=a)});const n=new Map;for(const t of i){const e=n.get(t.cluster)||0;n.set(t.cluster,Math.max(e,t.column+1))}return i.map(t=>({...t.event,column:t.column,totalColumns:n.get(t.cluster)||1}))}function Wt(t,e){return t.filter(t=>!e.has(t.calendar_entity_id))}function qt(t,e=48){return(Qt[t]||Qt.cloudy)(e)}o`
  ::-webkit-scrollbar {
    width: 6px;
    height: 6px;
  }
...
`;const Qt={sunny:t=>R`
    ...
    </svg>`};let Xt=class extends lt{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.timeFormat="12h",this.hideColumnHeaders=!1}firstUpdated(){this._scrollToNow()}updated(t){super.updated(t),t.has("currentDate")&&this._scrollToNow()}_scrollToNow(){requestAnimationFrame(()=>{const t=this.shadowRoot?.querySelector(".time-grid-wrapper");if(!t)return;this._scrollContainer=t;const e=new Date,i=60*(e.getHours()-0)+e.getMinutes();if(i>0&&i<1440){const e=i/1440*t.scrollHeight-t.clientHeight/3;t.scrollTo({top:Math.max(0,e),behavior:"smooth"})}})}render(){const t=Wt(this.events,this.hiddenCalendars),e=new Date(this.currentDate);e.setHours(0,0,0,0);const i=new Date(this.currentDate);i.setHours(23,59,59,999);const a=Vt(t,e,i),r=a.filter(t=>It(t)),n=a.filter(t=>!It(t)),s=this.calendars.filter(t=>!1!==t.visible&&!this.hiddenCalendars.has(t.entity_id)),o=function(t,e){const i=new Map,a=new Map(e.map(t=>[t.entity_id,t]));for(const t of e)if(!1!==t.visible){const e=t.person_entity||t.entity_id;i.has(e)||i.set(e,[])}for(const e of t){const t=a.get(e.calendar_entity_id),r=t?.person_entity||e.calendar_entity_id;i.has(r)||i.set(r,[]),i.get(r).push(e)}return i}(n,s),l=Array.from(o.keys()),c=new Date,d=c.toDateString()===this.currentDate.toDateString(),p=60*(c.getHours()-0)+c.getMinutes(),h=d?p/1440*100:-1;return 0===s.length?R`
      ...
      <div class="day-container">
        ...
        ${this.hideColumnHeaders?W:R`
          <div class="column-headers">
            ...
            ${l.map(t=>{const e=s.find(e=>(e.person_entity||e.entity_id)===t),i=e?.person_entity?bt(this.hass,e.person_entity):null,a=e?.person_entity?wt(this.hass,e.person_entity):e?.display_name||t;return R`
    ...
    `}_onEventClick(t){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:t},bubbles:!0,composed:!0}))}};Xt.styles=[Tt,Ht,Ut,jt,o`
    ...
    `}_renderAllDayBanner(t,e){const i=e.filter(t=>It(t));return 0===i.length?W:R`
    ...
    `}_renderTimeLabels(){const t=[];for(let e=0;e<=24;e++){const i=(e-0)/24*100;let a;if("24h"===this.timeFormat)a=`${String(e%24).padStart(2,"0")}:00`;else{const t=e%24;a=`${t%12||12} ${t>=12?"PM":"AM"}`}t.push(R`<div class="time-label" style="top: ${i}%">${a}</div>`)}return t}_renderHourLines(){const t=[],e=1/24*100;for(let i=0;i<24;i++){const a=(i-0)/24*100;i%2==1&&t.push(R`<div class="hour-band-odd" style="top: ${a}%; height: ${e}%"></div>`)}return t}_renderDayColumn(t,e,i){const a=t.toDateString()===i,r=new Date(t);r.setHours(0,0,0,0);const n=new Date(t);n.setHours(24,0,0,0);const s=e.filter(e=>{if(It(e))return!1;const i=new Date(e.start),a=new Date(e.end);return i<n&&a>r&&i.toDateString()===t.toDateString()}),o=Yt(s),l=new Date,c=60*(l.getHours()-0)+l.getMinutes(),d=a?c/1440*100:-1;return R`
            ...
            >
              ...
              ${t.shared_calendars?.length>1?R`
                <div class="shared-avatars">
                  ${t.shared_calendars.slice(0,3).map(t=>{const e=t.person_entity?bt(this.hass,t.person_entity):null;return e?R`<img class="shared-avatar" src="${e}" alt="${t.display_name}" />`:R`<div class="shared-avatar-initial" style="background: ${t.color}">${t.display_name[0]||"?"}</div>`})}
    ...
    `}_onEventClick(t){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:t},bubbles:!0,composed:!0}))}};Zt.styles=[Tt,Ht,Ut,o`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],t([vt({attribute:!1})],Zt.prototype,"hass",void 0),t([vt({type:Array})],Zt.prototype,"events",void 0),t([vt({type:Array})],Zt.prototype,"calendars",void 0),t([vt({type:Object})],Zt.prototype,"currentDate",void 0),t([vt({type:Object})],Zt.prototype,"hiddenCalendars",void 0),t([vt({attribute:!1})],Zt.prototype,"timeFormat",void 0),t([vt({attribute:!1})],Zt.prototype,"firstDay",void 0),Zt=t([dt("pv-view-week")],Zt);const Kt=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],Jt=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let Gt=class extends lt{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.firstDay="sunday"}render(){const t=Wt(this.events,this.hiddenCalendars),e=function(t,e="sunday"){const i=Dt(new Date(t.getFullYear(),t.getMonth(),1),e),a=[];for(let t=0;t<42;t++){const e=new Date(i);e.setDate(i.getDate()+t),a.push(e)}return a}(this.currentDate,this.firstDay),i=Nt(t),a=this.currentDate.getMonth(),r="monday"===this.firstDay?Jt:Kt;return R`
    ...
    `}_onDayClick(t){this.dispatchEvent(new CustomEvent("day-click",{detail:{date:t},bubbles:!0,composed:!0}))}_onEventClick(t){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:t},bubbles:!0,composed:!0}))}};Gt.styles=[Tt,Ht,o`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `}_renderEvent(t){const e=It(t),i=e?null:_t(t.start,this.timeFormat),a=e||!this.showEndTime?null:_t(t.end,this.timeFormat);return R`
    ...
    `}_onEventClick(t){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:t},bubbles:!0,composed:!0}))}};te.styles=[Tt,Ht,jt,o`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],t([vt({attribute:!1})],te.prototype,"hass",void 0),t([vt({type:Array})],te.prototype,"events",void 0),t([vt({type:Array})],te.prototype,"calendars",void 0),t([vt({type:Object})],te.prototype,"currentDate",void 0),t([vt({type:Object})],te.prototype,"hiddenCalendars",void 0),t([vt({attribute:!1})],te.prototype,"timeFormat",void 0),t([vt({type:Number})],te.prototype,"maxEvents",void 0),t([vt({type:Number})],te.prototype,"daysAhead",void 0),t([vt({type:Boolean})],te.prototype,"showCalendarName",void 0),t([vt({type:Boolean})],te.prototype,"showEndTime",void 0),t([vt({attribute:!1})],te.prototype,"maxHeight",void 0),te=t([dt("pv-view-agenda")],te);let ee=class extends lt{constructor(){super(...arguments),this.event=null,this.timeFormat="12h",this._confirmDelete=!1,this._deleting=!1,this._pv=new Et(this)}render(){if(!this.event)return W;const t=this.event,e=It(t),i=new Date(t.start);return R`
        ...
        <div class="pvc-filter-wrap">
          ...
          ${this._filterOpen?R`
            <div class="pvc-filter-panel">
              ${t.map(t=>{const e=!this._pv.state.hiddenCalendars.has(t.entity_id),i=t.person_entity?bt(this.hass,t.person_entity):null,a=t.display_name||(t.person_entity?wt(this.hass,t.person_entity):t.entity_id),r=(a||"?")[0].toUpperCase();return R`
                  <div
    ...
    `],t([vt({attribute:!1})],re.prototype,"hass",void 0),t([gt()],re.prototype,"_config",void 0),t([gt()],re.prototype,"_currentTime",void 0),t([gt()],re.prototype,"_filterOpen",void 0),re=t([dt("panavista-calendar-card")],re);let ne=class extends lt{constructor(){super(...arguments),this._pv=new Et(this),this._touchStartX=0}setConfig(t){this._config={entity:"sensor.panavista_config",...t},t.view&&this._pv.state.setView(t.view)}connectedCallback(){if(super.connectedCallback(),!this._config?.view){const t=this.hass?xt(this.hass,this._config?.entity):null;t?.display?.default_view&&this._pv.state.setView(t.display.default_view)}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=xt(this.hass,this._config?.entity);zt(this,Mt(this._config?.theme,t?.display?.theme))}}_getData(){return xt(this.hass,this._config?.entity)}render(){if(!this._config||!this.hass)return W;const t=this._getData();if(!t)return R`
        <ha-card>
    ...
    `],t([vt({attribute:!1})],ne.prototype,"hass",void 0),t([gt()],ne.prototype,"_config",void 0),ne=t([dt("panavista-grid-card")],ne);let se=class extends lt{constructor(){super(...arguments),this._pv=new Et(this)}setConfig(t){this._config={entity:"sensor.panavista_config",max_events:10,days_ahead:7,show_calendar_name:!0,show_end_time:!1,...t}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=xt(this.hass,this._config?.entity);zt(this,Mt(this._config?.theme,t?.display?.theme))}}render(){if(!this._config||!this.hass)return W;const t=xt(this.hass,this._config.entity);if(!t)return R`<ha-card><div style="padding:1rem;text-align:center;color:var(--pv-text-muted)">No data</div></ha-card>`;const e=Wt(t.events||[],this._pv.state.hiddenCalendars),i=this._config.time_format||t.display?.time_format||"12h";return R`
      <ha-card>
    ...
    `}_onEventClick(t){this._pv.state.selectEvent(t.detail.event)}getCardSize(){return 4}static getStubConfig(){return{entity:"sensor.panavista_config",max_events:10,days_ahead:7}}};se.styles=[Tt,o`
      :host { display: block; }
    ...
    `],t([vt({attribute:!1})],se.prototype,"hass",void 0),t([gt()],se.prototype,"_config",void 0),se=t([dt("panavista-agenda-card")],se);let oe=class extends lt{constructor(){super(...arguments),this._time="",this._date=""}setConfig(t){this._config={entity:"sensor.panavista_config",size:"large",show_date:!0,show_seconds:!1,time_format:void 0,align:"center",...t}}connectedCallback(){super.connectedCallback(),this._updateTime(),this._timer=setInterval(()=>this._updateTime(),1e3)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&(clearInterval(this._timer),this._timer=void 0)}_updateTime(){const t=new Date,e=this._config?.time_format||this._getDisplayConfig()?.time_format||"12h",i=this._config?.show_seconds||!1;if("24h"===e){const e=String(t.getHours()).padStart(2,"0"),a=String(t.getMinutes()).padStart(2,"0"),r=String(t.getSeconds()).padStart(2,"0");this._time=i?`${e}:${a}:${r}`:`${e}:${a}`}else{let e=t.getHours();const a=e>=12?"PM":"AM";e=e%12||12;const r=String(t.getMinutes()).padStart(2,"0"),n=String(t.getSeconds()).padStart(2,"0"),s=i?`${e}:${r}:${n}`:`${e}:${r}`;this._time=`${s}|${a}`}!1!==this._config?.show_date&&(this._date=$t(t,"long"))}_getDisplayConfig(){if(!this.hass)return;const t=xt(this.hass,this._config?.entity);return t?.display}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=this._getDisplayConfig();zt(this,Mt(this._config?.theme,t?.theme))}}render(){if(!this._config)return W;const t=this._config.size||"large",e=this._config.align||"center",i=`${this._config.background?`background: ${this._config.background};`:""}${this._config.text_color?`color: ${this._config.text_color};`:""}`,a=this._time.split("|"),r=a[0],n=a[1]||"";return R`
      <ha-card style="${i}">
    ...
    `}getCardSize(){const t=this._config?.size||"large";return"small"===t?2:"medium"===t?3:4}static getConfigElement(){return document.createElement("panavista-clock-card-editor")}static getStubConfig(){return{entity:"sensor.panavista_config",size:"large",show_date:!0}}};oe.styles=[Tt,o`
      :host {
        display: block;
      }
    ...
    `],t([vt({attribute:!1})],oe.prototype,"hass",void 0),t([gt()],oe.prototype,"_config",void 0),t([gt()],oe.prototype,"_time",void 0),t([gt()],oe.prototype,"_date",void 0),oe=t([dt("panavista-clock-card")],oe);let le=class extends lt{setConfig(t){this._config=t}render(){return this._config?R`
      <div class="editor">
        <div class="row">
          <label>Size</label>
  ...
  `,t([vt({attribute:!1})],le.prototype,"hass",void 0),t([gt()],le.prototype,"_config",void 0),le=t([dt("panavista-clock-card-editor")],le);const ce={sunny:"linear-gradient(135deg, #FBBF24 0%, #F97316 100%)","clear-night":"linear-gradient(135deg, #1E3A5F 0%, #0F172A 100%)",cloudy:"linear-gradient(135deg, #94A3B8 0%, #64748B 100%)",partlycloudy:"linear-gradient(135deg, #60A5FA 0%, #818CF8 100%)",rainy:"linear-gradient(135deg, #475569 0%, #334155 100%)",pouring:"linear-gradient(135deg, #334155 0%, #1E293B 100%)",snowy:"linear-gradient(135deg, #CBD5E1 0%, #94A3B8 100%)",fog:"linear-gradient(135deg, #94A3B8 0%, #CBD5E1 100%)",lightning:"linear-gradient(135deg, #475569 0%, #1E293B 100%)",windy:"linear-gradient(135deg, #60A5FA 0%, #3B82F6 100%)",default:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"};let de=class extends lt{setConfig(t){this._config={entity:"sensor.panavista_config",show_details:!0,show_forecast:!1,layout:"horizontal",...t}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=this._getDisplayConfig();zt(this,Mt(this._config?.theme,t?.theme))}}_getDisplayConfig(){if(this.hass)return xt(this.hass,this._config?.entity)?.display}_getWeatherEntity(){const t=this._config?.weather_entity||this._getDisplayConfig()?.weather_entity;return t?this.hass?.states?.[t]:null}render(){if(!this._config||!this.hass)return W;const t=this._getWeatherEntity();if(!t)return R`
        <ha-card>
      ...
      `;const e=t.state||"cloudy",i=Math.round(t.attributes.temperature??0),a=t.attributes.humidity,r=t.attributes.wind_speed,n=t.attributes.temperature_unit||"°F",s=t.attributes.wind_speed_unit||"mph",o=!1!==this._config.show_details,l=!0===this._config.show_forecast,c=t.attributes.forecast||[],d=this._config.layout||"horizontal",p=this._config.background||ce[e]||ce.default,h=this._config.text_color||"white";return R`
    ...
    `}getCardSize(){return this._config?.show_forecast?4:2}static getStubConfig(){return{entity:"sensor.panavista_config",show_details:!0,show_forecast:!1}}};de.styles=[Tt,Pt,o`
    ...
    `],t([vt({attribute:!1})],de.prototype,"hass",void 0),t([gt()],de.prototype,"_config",void 0),de=t([dt("panavista-weather-card")],de);let pe=class extends lt{constructor(){super(...arguments),this._pv=new Et(this)}setConfig(t){this._config={entity:"sensor.panavista_config",layout:"horizontal",show_names:!0,show_add_button:!0,...t}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=xt(this.hass,this._config?.entity);zt(this,Mt(this._config?.theme,t?.display?.theme))}}_getCalendars(){if(!this.hass)return[];const t=xt(this.hass,this._config?.entity);return t?.calendars||[]}_isHidden(t){return this._pv.state.hiddenCalendars.has(t)}_toggleCalendar(t){this._pv.state.toggleCalendar(t)}_openCreateDialog(){this._pv.state.openCreateDialog()}_setView(t){this._pv.state.setView(t)}render(){if(!this._config||!this.hass)return W;const t=this._getCalendars(),e=this._config.layout||"horizontal",i=!1!==this._config.show_names,a=!1!==this._config.show_add_button,r=this._pv.state.currentView;return R`
      <ha-card>
    ...
    `}_renderToggle(t,e){const i=this._isHidden(t.entity_id),a=t.person_entity?bt(this.hass,t.person_entity):null,r=e?t.person_entity?wt(this.hass,t.person_entity):t.display_name:"",n=r?r[0].toUpperCase():"?";return R`
      <button
    ...
    `}getCardSize(){return 2}static getStubConfig(){return{entity:"sensor.panavista_config",show_names:!0,show_add_button:!0}}};pe.styles=[Tt,Bt,o`
      :host { display: block; }
