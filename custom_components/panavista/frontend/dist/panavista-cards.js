...
`;const Qt={sunny:t=>R`
    ...
    `],t([vt({attribute:!1})],ne.prototype,"hass",void 0),t([gt()],ne.prototype,"_config",void 0),ne=t([ct("panavista-grid-card")],ne);let se=class extends lt{constructor(){super(...arguments),this._pv=new Et(this)}setConfig(t){this._config={entity:"sensor.panavista_config",max_events:10,days_ahead:7,show_calendar_name:!0,show_end_time:!1,...t}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=bt(this.hass,this._config?.entity);zt(this,Tt(this._config?.theme,t?.display?.theme))}}render(){if(!this._config||!this.hass)return W;const t=bt(this.hass,this._config.entity);if(!t)return R`<ha-card><div style="padding:1rem;text-align:center;color:var(--pv-text-muted)">No data</div></ha-card>`;const e=Wt(t.events||[],this._pv.state.hiddenCalendars),i=this._config.time_format||t.display?.time_format||"12h";return R`
      <ha-card>
    ...
    `}_onEventClick(t){this._pv.state.selectEvent(t.detail.event)}getCardSize(){return 4}static getStubConfig(){return{entity:"sensor.panavista_config",max_events:10,days_ahead:7}}};se.styles=[Mt,o`
      :host { display: block; }
    ...
    `}getCardSize(){const t=this._config?.size||"large";return"small"===t?2:"medium"===t?3:4}static getConfigElement(){return document.createElement("panavista-clock-card-editor")}static getStubConfig(){return{entity:"sensor.panavista_config",size:"large",show_date:!0}}};oe.styles=[Mt,o`
      :host {
        display: block;
      }
  ...
  `,t([vt({attribute:!1})],le.prototype,"hass",void 0),t([gt()],le.prototype,"_config",void 0),le=t([ct("panavista-clock-card-editor")],le);const de={sunny:"linear-gradient(135deg, #FBBF24 0%, #F97316 100%)","clear-night":"linear-gradient(135deg, #1E3A5F 0%, #0F172A 100%)",cloudy:"linear-gradient(135deg, #94A3B8 0%, #64748B 100%)",partlycloudy:"linear-gradient(135deg, #60A5FA 0%, #818CF8 100%)",rainy:"linear-gradient(135deg, #475569 0%, #334155 100%)",pouring:"linear-gradient(135deg, #334155 0%, #1E293B 100%)",snowy:"linear-gradient(135deg, #CBD5E1 0%, #94A3B8 100%)",fog:"linear-gradient(135deg, #94A3B8 0%, #CBD5E1 100%)",lightning:"linear-gradient(135deg, #475569 0%, #1E293B 100%)",windy:"linear-gradient(135deg, #60A5FA 0%, #3B82F6 100%)",default:"linear-gradient(135deg, #667eea 0%, #764ba2 100%)"};let ce=class extends lt{setConfig(t){this._config={entity:"sensor.panavista_config",show_details:!0,show_forecast:!1,layout:"horizontal",...t}}updated(t){if(super.updated(t),t.has("hass")||t.has("_config")){const t=this._getDisplayConfig();zt(this,Tt(this._config?.theme,t?.theme))}}_getDisplayConfig(){if(this.hass)return bt(this.hass,this._config?.entity)?.display}_getWeatherEntity(){const t=this._config?.weather_entity||this._getDisplayConfig()?.weather_entity;return t?this.hass?.states?.[t]:null}render(){if(!this._config||!this.hass)return W;const t=this._getWeatherEntity();if(!t)return R`
    ...
    `}getCardSize(){return this._config?.show_forecast?4:2}static getStubConfig(){return{entity:"sensor.panavista_config",show_details:!0,show_forecast:!1}}};ce.styles=[Mt,Bt,o`
    ...
    `}getCardSize(){return 2}static getStubConfig(){return{entity:"sensor.panavista_config",show_names:!0,show_add_button:!0}}};pe.styles=[Mt,Ht,o`
      :host { display: block; }
