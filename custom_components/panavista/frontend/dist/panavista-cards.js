...
`;var ke;let Fe=ke=class extends oe{constructor(){super(...arguments),this.value="",this.valueLight="",this._isCustom=!1}updated(e){if(super.updated(e),e.has("value")&&this.value){const e=ke.PRESETS.some(e=>e.color.toLowerCase()===this.value.toLowerCase());this._isCustom=!e}}_selectPreset(e){this._isCustom=!1,this._emit(e.color,e.light)}_openCustomPicker(){this._colorInput?.click()}_onCustomColorChange(e){const t=e.target.value,i=function(e){let t=e.replace("#","");if(3===t.length&&(t=t.split("").map(e=>e+e).join("")),6!==t.length)return e;const i=parseInt(t.substring(0,2),16),r=parseInt(t.substring(2,4),16),a=parseInt(t.substring(4,6),16);if(isNaN(i)||isNaN(r)||isNaN(a))return e;const n=Math.round(i+.65*(255-i)),s=Math.round(r+.65*(255-r)),o=Math.round(a+.65*(255-a)),l=e=>e.toString(16).padStart(2,"0");return`#${l(n)}${l(s)}${l(o)}`}(t);this._isCustom=!0,this._emit(t,i)}_emit(e,t){this.value=e,this.valueLight=t,this.dispatchEvent(new CustomEvent("color-change",{detail:{color:e,colorLight:t},bubbles:!0,composed:!0}))}_isSelected(e){return this.value.toLowerCase()===e.toLowerCase()}render(){const e=ke.PRESETS,t=this._isCustom?this.value:"",i=this._isCustom&&!!this.value;return R`
    ...
    `}_renderAvatars(e){const t=e.slice(0,4),i=e.length-4;return R`
      <div class="chip-avatars">
        ${t.map(e=>{const t=e.person_entity?Je(this.hass,e.person_entity):null,i=e.person_entity?et(this.hass,e.person_entity):e.display_name||"?";return t?R`<img class="chip-avatar" src="${t}" alt="${i}" />`:R`<div class="chip-initial" style="background: ${e.color}">${i[0]?.toUpperCase()||"?"}</div>`})}
        ${i>0?R`<div class="chip-overflow">+${i}</div>`:W}
      </div>
    `}_onClick(){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:this.event},bubbles:!0,composed:!0}))}};tt.styles=[ge,s`
      :host { display: block; }
    ...
    `],e([he({attribute:!1})],tt.prototype,"hass",void 0),e([he({attribute:!1})],tt.prototype,"event",void 0),e([he({attribute:!1})],tt.prototype,"calendars",void 0),e([he({attribute:!1})],tt.prototype,"timeFormat",void 0),e([he({type:Boolean})],tt.prototype,"compact",void 0),e([he({type:Boolean})],tt.prototype,"showStripes",void 0),tt=e([de("pv-event-chip")],tt);class it{constructor(){this.hiddenCalendars=new Set,this.currentView="day",this.currentDate=new Date,this.selectedEvent=null,this.dialogOpen=null,this.createPrefill=null,this.isLoading=!1,this._hosts=new Set,this._autoAdvanceTimer=null,this.startAutoAdvance()}static getInstance(){return it._instance||(it._instance=new it),it._instance}subscribe(e){this._hosts.add(e)}unsubscribe(e){this._hosts.delete(e)}_notify(){for(const e of this._hosts)e.requestUpdate()}toggleCalendar(e){this.hiddenCalendars.has(e)?this.hiddenCalendars.delete(e):this.hiddenCalendars.add(e),this._notify()}setView(e){this.currentView!==e&&(this.currentView=e,this._notify())}navigateDate(e){this.currentDate="today"===e?new Date:function(e,t,i){const r=new Date(e),a="next"===i?1:-1;switch(t){case"day":r.setDate(r.getDate()+a);break;case"week":case"agenda":r.setDate(r.getDate()+7*a);break;case"month":r.setMonth(r.getMonth()+a)}return r}(this.currentDate,this.currentView,e),this._notify()}setDate(e){this.currentDate=new Date(e),this._notify()}selectEvent(e){this.selectedEvent=e,this._notify()}openCreateDialog(e){this.dialogOpen="create",this.createPrefill=e||null,this._notify()}openEditDialog(e,t){this.dialogOpen="edit",this.selectedEvent=e;const i={...e};t?.removeGuests&&(i._removeGuestsHint=!0),this.createPrefill=i,this._notify()}closeDialog(){this.dialogOpen=null,this.createPrefill=null,this._notify()}async doCreateEvent(e,t){this.isLoading=!0,this._notify();try{await qe(e,t),await Qe(e),this.closeDialog()}catch(e){throw console.error("PanaVista: Failed to create event",e),e}finally{this.isLoading=!1,this._notify()}}async doDeleteEvent(e,t){this.isLoading=!0,this._notify();try{await Ge(e,t),await Qe(e),this.selectedEvent=null,this.closeDialog()}catch(e){throw console.error("PanaVista: Failed to delete event",e),e}finally{this.isLoading=!1,this._notify()}}async doEditEvent(e,t,i){this.isLoading=!0,this._notify();let r=!1;try{await Ge(e,t),r=!0,await qe(e,i),await Qe(e),this.selectedEvent=null,this.closeDialog()}catch(e){if(console.error("PanaVista: Failed to edit event",e),r)throw new Error("The original event was deleted but the replacement could not be created. Please create the event manually. Error: "+(e instanceof Error?e.message:String(e)));throw e}finally{this.isLoading=!1,this._notify()}}startAutoAdvance(){this._autoAdvanceTimer||(this._autoAdvanceTimer=setInterval(()=>{const e=new Date;e.getDate()===this.currentDate.getDate()&&e.getMonth()===this.currentDate.getMonth()&&e.getFullYear()===this.currentDate.getFullYear()||this.currentDate.toDateString()===new Date(Date.now()-6e4).toDateString()&&(this.currentDate=e,this._notify())},6e4))}stopAutoAdvance(){this._autoAdvanceTimer&&(clearInterval(this._autoAdvanceTimer),this._autoAdvanceTimer=null)}}class rt{constructor(e){this.host=e,this._state=it.getInstance(),e.addController(this)}hostConnected(){this._state.subscribe(this.host)}hostDisconnected(){this._state.unsubscribe(this.host)}get state(){return this._state}}function at(e,t=48){return(nt[e]||nt.cloudy)(t)}const nt={sunny:e=>R`
    ...
    </svg>`};let st=class extends oe{constructor(){super(...arguments),this._config={}}setConfig(e){this._config=e}render(){return R`
  ...
  `,e([he({attribute:!1})],st.prototype,"hass",void 0),st=e([de("panavista-calendar-card-editor")],st);let ot=class extends oe{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.timeFormat="12h",this.hideColumnHeaders=!1,this.avatarBorderMode="primary",this.sharedEventMap=new Map}firstUpdated(){this._scrollToNow()}updated(e){super.updated(e),e.has("currentDate")&&this._scrollToNow()}_scrollToNow(){requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".time-grid-wrapper");if(!e)return;this._scrollContainer=e;const t=new Date,i=60*(t.getHours()-0)+t.getMinutes();if(i>0&&i<1440){const t=i/1440*e.scrollHeight-e.clientHeight/3;e.scrollTo({top:Math.max(0,t),behavior:"smooth"})}})}render(){const e=Pe(this.events,this.hiddenCalendars),t=new Date(this.currentDate);t.setHours(0,0,0,0);const i=new Date(this.currentDate);i.setHours(23,59,59,999);const r=Oe(e,t,i),a=r.filter(e=>Te(e)),n=r.filter(e=>!Te(e)),s=this.calendars.filter(e=>!1!==e.visible&&!this.hiddenCalendars.has(e.entity_id)),o=function(e,t){const i=new Map,r=new Map(t.map(e=>[e.entity_id,e]));for(const e of t)if(!1!==e.visible){const t=e.person_entity||e.entity_id;i.has(t)||i.set(t,[])}for(const t of e){const e=r.get(t.calendar_entity_id),a=e?.person_entity||t.calendar_entity_id;i.has(a)||i.set(a,[]),i.get(a).push(t)}return i}(n,s),l=Array.from(o.keys()),d=new Date,c=d.toDateString()===this.currentDate.toDateString(),p=60*(d.getHours()-0)+d.getMinutes(),h=c?p/1440*100:-1;return 0===s.length?R`
      ...
      <div class="day-container">
        ...
        ${this.hideColumnHeaders?W:R`
          <div class="column-headers">
            ...
            ${l.map(e=>{const t=s.find(t=>(t.person_entity||t.entity_id)===e),i=t?.person_entity?Je(this.hass,t.person_entity):null,r=t?.person_entity?et(this.hass,t.person_entity):t?.display_name||e,a=t?.color||"#6366F1",n=t?.color_light||a,o="light"===this.avatarBorderMode?n:"primary"===this.avatarBorderMode?a:this.avatarBorderMode;return R`
        ...
        ${i.map(e=>{const t=function(e,t=0,i=24){const r=new Date(e.start),a=new Date(e.end),n=60*(i-t);let s,o;return s=Math.max(0,60*(r.getHours()-t)+r.getMinutes()),o=Math.min(n,60*(a.getHours()-t)+a.getMinutes()),a.toDateString()!==r.toDateString()&&o<=0&&(o=n),s=Math.max(0,Math.min(s,n)),o=Math.max(0,Math.min(o,n)),{top:s/n*100,height:Math.max(o-s,15)/n*100}}(e,0,24),i=e.totalColumns>1?`calc(${100/e.totalColumns}% - 6px)`:"calc(100% - 6px)",r=e.totalColumns>1?`calc(${e.column/e.totalColumns*100}% + 3px)`:"3px",a=e.uid?this.sharedEventMap.get(e.uid):void 0,n=a&&a.length>1;return R`
            <div
              ...
              style="
                ...
                --event-text: ${Le(e.calendar_color_light||e.calendar_color)};
              "
              @click=${()=>this._onEventClick(e)}
            >
              ...
              ${n?R`
                <div class="event-participants">
                  ${a.map(e=>{const t=e.person_entity?Je(this.hass,e.person_entity):null,i=e.person_entity?et(this.hass,e.person_entity):e.calendar_name;return t?R`<img class="event-participant-avatar"
                          src="${t}" alt="${i}"
    ...
    `}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};ot.styles=[ge,ye,_e,we,s`
    ...
    `}_renderDayCard(e,t,i){const r=De(e),a=Ae(e),n=new Date(e);n.setHours(0,0,0,0);const s=new Date(e);s.setHours(23,59,59,999);const o=t.filter(e=>{const t=new Date(e.start),i=new Date(e.end);return t<s&&i>n}).sort((e,t)=>{const i=Te(e),r=Te(t);return i&&!r?-1:!i&&r?1:new Date(e.start).getTime()-new Date(t.start).getTime()}),l=i.get(a),d=`${lt[e.getDay()]} ${e.getDate()}`,c=o.length;return R`
    ...
    `}_addEvent(e){this.dispatchEvent(new CustomEvent("create-event",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};dt.styles=[ge,we,s`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],e([he({attribute:!1})],dt.prototype,"hass",void 0),e([he({type:Array})],dt.prototype,"events",void 0),e([he({type:Array})],dt.prototype,"calendars",void 0),e([he({type:Object})],dt.prototype,"currentDate",void 0),e([he({type:Object})],dt.prototype,"hiddenCalendars",void 0),e([he({attribute:!1})],dt.prototype,"timeFormat",void 0),e([he({attribute:!1})],dt.prototype,"firstDay",void 0),e([he({attribute:!1})],dt.prototype,"weatherEntity",void 0),e([he({type:Boolean})],dt.prototype,"showStripes",void 0),e([ve()],dt.prototype,"_forecast",void 0),dt=e([de("pv-view-week")],dt);const ct=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],pt=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let ht=class extends oe{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.firstDay="sunday",this.timeFormat="12h",this.showStripes=!0}render(){const e=Me(Pe(this.events,this.hiddenCalendars),this.calendars),t=function(e,t="sunday"){const i=Se(new Date(e.getFullYear(),e.getMonth(),1),t),r=[];for(let e=0;e<42;e++){const t=new Date(i);t.setDate(i.getDate()+e),r.push(t)}return r}(this.currentDate,this.firstDay),i=Be(e),r=this.currentDate.getMonth(),a="monday"===this.firstDay?pt:ct,n=this.currentDate.toLocaleDateString("en-US",{month:"long",year:"numeric"});return R`
    ...
    `}_onDayClick(e){this.dispatchEvent(new CustomEvent("day-click",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};ht.styles=[ge,s`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `}updated(e){super.updated(e),(e.has("weatherEntity")||e.has("hass"))&&this._subscribeWeather()}disconnectedCallback(){super.disconnectedCallback(),this._unsubWeather()}_unsubWeather(){this._weatherUnsub&&(this._weatherUnsub(),this._weatherUnsub=void 0),this._subscribedEntity=""}async _subscribeWeather(){if(!this.weatherEntity||!this.hass?.connection)return this._unsubWeather(),void(this._forecast=[]);if(this._subscribedEntity!==this.weatherEntity||!this._weatherUnsub){this._unsubWeather(),this._subscribedEntity=this.weatherEntity;try{this._weatherUnsub=await this.hass.connection.subscribeMessage(e=>{this._forecast=e.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:this.weatherEntity})}catch{const e=this.hass.states[this.weatherEntity];e?.attributes?.forecast&&(this._forecast=e.attributes.forecast)}}}_getForecastMap(){const e=new Map;for(const t of this._forecast){if(!t.datetime)continue;const i=Ae(new Date(t.datetime));e.set(i,{condition:t.condition||"",tempHigh:t.temperature??0,tempLow:t.templow??t.temperature??0})}return e}_loadMore(){this._daysLoaded+=14}_addEvent(e){this.dispatchEvent(new CustomEvent("create-event",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};mt.styles=[ge,we,s`
      :host { display: block; height: 100%; overflow: hidden; }
    ...
    `],e([he({attribute:!1})],mt.prototype,"hass",void 0),e([he({type:Array})],mt.prototype,"events",void 0),e([he({type:Array})],mt.prototype,"calendars",void 0),e([he({type:Object})],mt.prototype,"currentDate",void 0),e([he({type:Object})],mt.prototype,"hiddenCalendars",void 0),e([he({attribute:!1})],mt.prototype,"timeFormat",void 0),e([he({attribute:!1})],mt.prototype,"weatherEntity",void 0),e([he({type:Boolean})],mt.prototype,"showStripes",void 0),e([ve()],mt.prototype,"_daysLoaded",void 0),e([ve()],mt.prototype,"_forecast",void 0),mt=e([de("pv-view-agenda")],mt);let gt=class extends oe{constructor(){super(...arguments),this.event=null,this.timeFormat="12h",this._confirmDelete=!1,this._deleteMode=null,this._deleting=!1,this._deleteError="",this._organizerEntityId=null,this._pv=new rt(this),this._lastOrganizerUid=""}updated(e){if(super.updated(e),e.has("event")&&this.event){const e=this.event.shared_calendars,t=this.event.uid||"";e&&e.length>1&&t&&t!==this._lastOrganizerUid?(this._lastOrganizerUid=t,this._organizerEntityId=null,this._fetchOrganizer(this.event.calendar_entity_id,t)):(!e||e.length<=1)&&(this._organizerEntityId=null,this._lastOrganizerUid="")}}async _fetchOrganizer(e,t){this._organizerEntityId=await Ke(this.hass,e,t)}render(){if(!this.event)return W;const e=this.event,t=Te(e),i=new Date(e.start),r=e.shared_calendars,a=r&&r.length>1;return R`
    ...
    `}_renderDatePickerDropdown(){if(!this._datePickerOpen)return W;const e=this._dateDisplay;if(!e)return W;const t=e.getBoundingClientRect(),i=window.innerHeight-t.bottom-8<330&&t.top>330?t.top-330-4:t.bottom+4;return R`
      ...
      >
        ...
        <div class="picker-weekdays">
          ${ut.map(e=>R`<span class="picker-weekday">${e}</span>`)}
        </div>
        ...
        <div class="pvc-filter-wrap">
          ...
          ${this._filterOpen?R`
            <div class="pvc-filter-panel">
              ${e.map(e=>{const t=!this._pv.state.hiddenCalendars.has(e.entity_id),i=e.person_entity?Je(this.hass,e.person_entity):null,r=e.display_name||(e.person_entity?et(this.hass,e.person_entity):e.entity_id),a=(r||"?")[0].toUpperCase();return R`
                  <div
    ...
    `],e([he({attribute:!1})],yt.prototype,"hass",void 0),e([ve()],yt.prototype,"_config",void 0),e([ve()],yt.prototype,"_currentTime",void 0),e([ve()],yt.prototype,"_filterOpen",void 0),e([ve()],yt.prototype,"_wizardOpen",void 0),e([ve()],yt.prototype,"_onboardingDone",void 0),e([ve()],yt.prototype,"_settingsOpen",void 0),e([ve()],yt.prototype,"_refreshing",void 0),e([ve()],yt.prototype,"_previewOverrides",void 0),yt=e([de("panavista-calendar-card")],yt),window.customCards=window.customCards||[],window.customCards.push({type:"panavista-calendar-card",name:"PanaVista Calendar",description:"All-in-one calendar with clock, weather, toggles, and views",preview:!0}),console.info("%c PANAVISTA %c v1.0.0 ","color: white; background: #6366F1; font-weight: bold; border-radius: 4px 0 0 4px; padding: 2px 6px;","color: #6366F1; background: #EEF2FF; font-weight: bold; border-radius: 0 4px 4px 0; padding: 2px 6px;");
