...
`;var ke;let Fe=ke=class extends oe{constructor(){super(...arguments),this.value="",this.valueLight="",this._isCustom=!1}updated(e){if(super.updated(e),e.has("value")&&this.value){const e=ke.PRESETS.some(e=>e.color.toLowerCase()===this.value.toLowerCase());this._isCustom=!e}}_selectPreset(e){this._isCustom=!1,this._emit(e.color,e.light)}_openCustomPicker(){this._colorInput?.click()}_onCustomColorChange(e){const t=e.target.value,i=function(e){let t=e.replace("#","");if(3===t.length&&(t=t.split("").map(e=>e+e).join("")),6!==t.length)return e;const i=parseInt(t.substring(0,2),16),r=parseInt(t.substring(2,4),16),a=parseInt(t.substring(4,6),16);if(isNaN(i)||isNaN(r)||isNaN(a))return e;const n=Math.round(i+.65*(255-i)),s=Math.round(r+.65*(255-r)),o=Math.round(a+.65*(255-a)),l=e=>e.toString(16).padStart(2,"0");return`#${l(n)}${l(s)}${l(o)}`}(t);this._isCustom=!0,this._emit(t,i)}_emit(e,t){this.value=e,this.valueLight=t,this.dispatchEvent(new CustomEvent("color-change",{detail:{color:e,colorLight:t},bubbles:!0,composed:!0}))}_isSelected(e){return this.value.toLowerCase()===e.toLowerCase()}render(){const e=ke.PRESETS,t=this._isCustom?this.value:"",i=this._isCustom&&!!this.value;return N`
  ...
  `,e([he({attribute:!1})],at.prototype,"hass",void 0),at=e([de("panavista-calendar-card-editor")],at);let nt=class extends oe{constructor(){super(...arguments),this.events=[],this.calendars=[],this.currentDate=new Date,this.hiddenCalendars=new Set,this.timeFormat="12h",this.hideColumnHeaders=!1,this.avatarBorderMode="primary"}firstUpdated(){this._scrollToNow()}updated(e){super.updated(e),e.has("currentDate")&&this._scrollToNow()}_scrollToNow(){requestAnimationFrame(()=>{const e=this.shadowRoot?.querySelector(".time-grid-wrapper");if(!e)return;this._scrollContainer=e;const t=new Date,i=60*(t.getHours()-0)+t.getMinutes();if(i>0&&i<1440){const t=i/1440*e.scrollHeight-e.clientHeight/3;e.scrollTo({top:Math.max(0,t),behavior:"smooth"})}})}render(){const e=Pe(this.events,this.hiddenCalendars),t=new Date(this.currentDate);t.setHours(0,0,0,0);const i=new Date(this.currentDate);i.setHours(23,59,59,999);const r=Oe(e,t,i),a=r.filter(e=>Me(e)),n=r.filter(e=>!Me(e)),s=this.calendars.filter(e=>!1!==e.visible&&!this.hiddenCalendars.has(e.entity_id)),o=function(e,t){const i=new Map,r=new Map(t.map(e=>[e.entity_id,e]));for(const e of t)if(!1!==e.visible){const t=e.person_entity||e.entity_id;i.has(t)||i.set(t,[])}for(const t of e){const e=r.get(t.calendar_entity_id),a=e?.person_entity||t.calendar_entity_id;i.has(a)||i.set(a,[]),i.get(a).push(t)}return i}(n,s),l=Array.from(o.keys()),d=new Date,c=d.toDateString()===this.currentDate.toDateString(),p=60*(d.getHours()-0)+d.getMinutes(),h=c?p/1440*100:-1;return 0===s.length?N`
      ...
      <div class="day-container">
        ...
        ${this.hideColumnHeaders?W:N`
          <div class="column-headers">
            ...
            ${l.map(e=>{const t=s.find(t=>(t.person_entity||t.entity_id)===e),i=t?.person_entity?Ke(this.hass,t.person_entity):null,r=t?.person_entity?Ge(this.hass,t.person_entity):t?.display_name||e,a=t?.color||"#6366F1",n=t?.color_light||a,o="light"===this.avatarBorderMode?n:"primary"===this.avatarBorderMode?a:this.avatarBorderMode;return N`
    ...
    `}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};nt.styles=[me,ye,we,_e,s`
    ...
    `}_renderDayCard(e,t,i){const r=ze(e),a=Ae(e),n=new Date(e);n.setHours(0,0,0,0);const s=new Date(e);s.setHours(23,59,59,999);const o=t.filter(e=>{const t=new Date(e.start),i=new Date(e.end);return t<s&&i>n}).sort((e,t)=>{const i=Me(e),r=Me(t);return i&&!r?-1:!i&&r?1:new Date(e.start).getTime()-new Date(t.start).getTime()}),l=i.get(a),d=`${st[e.getDay()]} ${e.getDate()}`,c=o.length;return N`
    ...
    `}updated(e){super.updated(e),(e.has("weatherEntity")||e.has("hass"))&&this._subscribeWeather()}disconnectedCallback(){super.disconnectedCallback(),this._unsubWeather()}_unsubWeather(){this._weatherUnsub&&(this._weatherUnsub(),this._weatherUnsub=void 0),this._subscribedEntity=""}async _subscribeWeather(){if(!this.weatherEntity||!this.hass?.connection)return this._unsubWeather(),void(this._forecast=[]);if(this._subscribedEntity!==this.weatherEntity||!this._weatherUnsub){this._unsubWeather(),this._subscribedEntity=this.weatherEntity;try{this._weatherUnsub=await this.hass.connection.subscribeMessage(e=>{this._forecast=e.forecast||[]},{type:"weather/subscribe_forecast",forecast_type:"daily",entity_id:this.weatherEntity})}catch{const e=this.hass.states[this.weatherEntity];e?.attributes?.forecast&&(this._forecast=e.attributes.forecast)}}}_getForecastMap(){const e=new Map;for(const t of this._forecast){if(!t.datetime)continue;const i=Ae(new Date(t.datetime));e.set(i,{condition:t.condition||"",tempHigh:t.temperature??0,tempLow:t.templow??t.temperature??0})}return e}_loadMore(){this._daysLoaded+=14}_addEvent(e){this.dispatchEvent(new CustomEvent("create-event",{detail:{date:e},bubbles:!0,composed:!0}))}_onEventClick(e){this.dispatchEvent(new CustomEvent("event-click",{detail:{event:e},bubbles:!0,composed:!0}))}};ht.styles=[me,_e,s`
      :host { display: block; height: 100%; overflow: hidden; }
