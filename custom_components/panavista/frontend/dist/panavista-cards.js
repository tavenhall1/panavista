...
`;const qt={sunny:t=>R`
    ...
    `}_renderEvent(t){const e=Lt(t),i=e?null:xt(t.start,this.timeFormat),a=e||!this.showEndTime?null:xt(t.end,this.timeFormat);return R`
